...
- 🇷🇺 **Работает в РФ** — модели загружаются с hf-mirror.com (работает без VPN)
...
Модели загружаются с **hf-mirror.com** - китайского зеркала Hugging Face:
...
Если hf-mirror.com недоступен:
- Используйте VPN для доступа к обычному Hugging Face
- Скачайте модель вручную с [Hugging Face](https://huggingface.co/bgkb/bs_polarformer)
