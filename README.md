...
Используются модели **UVR-MDX-NET** из проекта [sherpa-onnx](https://github.com/k2-fsa/sherpa-onnx):
...
Все модели хранятся на **GitHub Releases** и доступны в России без VPN.
