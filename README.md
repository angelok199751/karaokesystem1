...
|--------|--------|----------|
| BS-Roformer-SW FP16 | 336 MB | Рекомендуемая, лучшее качество |
| BS-Roformer-SW FP32 | 669 MB | Fallback, если FP16 не работает |

### Выходы модели (6 stems):
1. 🎸 **Bass** — бас-гитара
2. 🥁 **Drums** — ударные
3. 🎵 **Other** — остальные инструменты
4. 🎤 **Vocals** — вокал
5. 🎸 **Guitar** — гитара
6. 🎹 **Piano** — пианино
...
- **Выход:** 6 WAV файлов (bass, drums, other, vocals, guitar, piano)
...
5. **Инференс** — спектрограммы подаются в модель, которая возвращает маски для 6 stems
...
8. **Экспорт** — результаты кодируются в WAV для воспроизведения/скачивания
