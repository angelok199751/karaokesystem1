...
- 🧠 **ML-модели** — BS PolarFormer (современная архитектура для разделения вокала)
...
- 🇷🇺 **Работает в РФ** — модели загружаются с GitHub через систему прокси

## 🧠 Модели

Используются модели **BS PolarFormer** - современная архитектура для разделения вокала:

| Модель | Размер | Описание |
|--------|--------|----------|
| BS PolarFormer FP16 | 103 MB | Рекомендуемая, хорошее качество |
| BS PolarFormer FP32 | 201 MB | Максимальное качество |

### 🌐 Система загрузки

Модели загружаются с **GitHub** через систему прокси с автоматическим fallback:

1. **raw.githubusercontent.com** - прямой доступ
2. **ghproxy.com** - прокси для GitHub
3. **gh-proxy.com** - альтернативный прокси
4. **mirror.ghproxy.com** - дополнительный прокси
5. **hub.gitmirror.com** - ещё один прокси
...
- Используйте VPN для доступа к GitHub
- Скачайте модель вручную с [GitHub](https://github.com/bgkb/bs_polarformer)
